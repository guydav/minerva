...
class Pitch(BaseModel):
    ...
    at_bat = ForeignKeyField(AtBat, related_name='pitches', index=True)
    ...
    # pitch_type = ForeignKeyField(PitchType, db_column='pitch_type', related_name='pitches')
    px = FloatField(null=True)
    pz = FloatField(null=True)
...
class PitchTransition(BaseModel):
    ...
    at_bat = ForeignKeyField(AtBat, db_column='ab_id', related_name='pitch_transitions')
    batter = ForeignKeyField(Player, db_column='batter', related_name='pitch_transitions_batted')
    pitcher = ForeignKeyField(Player, db_column='pitcher', related_name='pitch_transitions_pitched')
